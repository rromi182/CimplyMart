...
$url_ciu_print = $url_base . "/modules/ciudad/print.php";
$url_ciu_form = $url_base . "/modules/ciudad/form.php";
?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        <li class="fa fa-city icon-title" style="margin: 5px;"></li> Ciudades
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <a class="btn btn-warning pull-left" href="<?php echo $url_ciu_print ?>" title="Imprimir Reporte"
                    data-toggle="tool-tip" style="margin-top: 10px; margin-right: 10px" target="_blank">
                    <i class="fa fa-print"></i> Imprimir Reporte
                </a>
                <a class="btn btn-info" href="<?php echo $url_ciu_form ?>?form=add" title="Agregar"
                    ...
                    <div class="box-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               class='btn btn-primary btn-sm' href='$url_ciu_form?form=edit&id=$data[cod_ciudad]'>
                                    <i class='fa fa-edit' style='color:#fff'></i> </a>";
                                            ?>
                                            <a data-toggle="tooltip" data-data-placement="top" title="Eliminar datos"
                                                class="btn btn-danger btn-sm"
                                                href="<?php echo $url_ciu_process?>?act=delete&cod_ciudad=<?php echo $data['cod_ciudad']; ?>"
