...
$url_dep_print = $url_base."/modules/departamento/print.php";
$url_depart_form = $url_base . "/modules/departamento/form.php";
?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        <li class="fa fa-city icon-title" style="margin: 5px;"></li> Departamentos
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="box-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               class='btn btn-primary btn-sm' href='$url_depart_form?form=edit&id=$data[id_departamento]'>
                                    <i class='fa fa-edit' style='color:#fff'></i> </a>";
                                            ?>
                                            <a data-toggle="tooltip" data-data-placement="top" title="Eliminar datos"
                                                class="btn btn-danger btn-sm"
                                                href="<?php echo $url_depart_process?>?act=delete&id_departamento=<?php echo $data['id_departamento']; ?>"
                                                onclick="return confirm('¿Estás seguro/a de eliminar <?php echo $data['dep_descripcion']; ?>?')" style="margin-right:5px">
