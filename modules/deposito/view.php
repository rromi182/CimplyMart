...
$url_dep_print = $url_base."/modules/deposito/print.php";
$url_depart_form = $url_base . "/modules/deposito/form.php";
?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        <li class="fa fa-warehouse icon-title" style="margin: 5px;"></li> Depositos
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <a href="#" style="color: inherit; text-decoration: none;">
                            <li class="fas fa-angle-right" style="margin: 5px;"></li> Depositos
                        </a>
                    </ol>
                </div><!-- /.col -->
            </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4>  <i class='icon fa fa-check-circle'></i> Error!</h4>
                El Depósito ya existe, intente de nuevo.
                </div>";
                }
                ?>
                    ...
                    <div class="box-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               class='btn btn-primary btn-sm' href='$url_depart_form?form=edit&id=$data[cod_deposito]'>
                                    <i class='fa fa-edit' style='color:#fff'></i> </a>";
                                            ?>
                                            <a data-toggle="tooltip" data-data-placement="top" title="Eliminar datos"
                                                class="btn btn-danger btn-sm"
                                                href="<?php echo $url_depart_process?>?act=delete&cod_deposito=<?php echo $data['cod_deposito']; ?>"
                                                onclick="return confirm('¿Estás seguro/a de eliminar <?php echo $data['descrip']; ?>?')" style="margin-right:5px">
