                            ...
                            <table id="example1" class="table table-bordered table-striped">
                               ...
                               <div>"; ?>
                                        ...
                                        <a data-toggle="tooltip" data-placement="top" title="Rechazar Presupuesto"
                                            ...
                                            href="<?php echo $url_proses ?>?act=rechazar&id_orden_compra=<?php echo $data['id_orden_compra']; ?>"
                                            onclick="return confirm('Estás seguro/a de rechazar el presupuesto <?php echo $data['id_orden_compra']; ?>?');">
