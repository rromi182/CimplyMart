...
if ($_GET['form'] == 'add') { ?>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <a href="<?php echo $url_presupuesto_view ?>" style="color: inherit; text-decoration: none;">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            FROM pedido_compra WHERE estado = 'aprobado'
    ...
    <script>
        ...
        function cargarTabla(idPedido) {
            $.ajax({
                url: '../../ajax/cargarTablaPresupuesto.php',
                method: 'GET',
