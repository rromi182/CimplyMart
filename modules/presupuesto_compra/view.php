                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                               ...
                               <div>"; ?>
                                        ...
                                        <a data-toggle="tooltip" data-placement="top" title="Rechazar Presupuesto"
                                            class="btn btn-danger btn-sm"
                                            href="<?php echo $url_proses ?>?act=rechazar&id_presupuesto_compra=<?php echo $data['id_presupuesto_compra']; ?>"
                                            onclick="return confirm('Estás seguro/a de rechazar el presupuesto <?php echo $data['id_presupuesto_compra']; ?>?');">
